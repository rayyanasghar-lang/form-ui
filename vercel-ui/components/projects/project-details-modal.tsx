      ...
      <DialogContent className="max-w-4xl max-h-[90vh] p-0 overflow-hidden bg-background border-border rounded-4xl shadow-2xl">
        <DialogHeader className="p-8 pb-0 flex flex-row items-center justify-between">
          ...
          <div className="flex gap-2 mr-4">
            <Button variant="outline" size="sm" className="rounded-xl border-border bg-card font-bold h-10 px-4 group shadow-sm hover:bg-secondary transition-all text-zinc-900 hover:text-primary">
              <Edit className="w-4 h-4 mr-2 group-hover:text-primary transition-colors" />
              Edit
            </Button>
            <Button 
              className="rounded-xl font-bold h-10 px-4 text-white shadow-lg shadow-primary/20 hover:scale-105 transition-all active:scale-95 bg-primary" 
