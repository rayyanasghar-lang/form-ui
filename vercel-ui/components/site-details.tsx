...
export default function SiteDetails({ systemType, formData, onUpdateField, onFileUpload }: SiteDetailsProps) {
    ...
    if (systemType === "groundmount") {
        return (
            <div className="space-y-4">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className="space-y-2">
                        <Label htmlFor="groundMountType">Ground Mount Type</Label>
                    ...
                    <div className="space-y-2">
                        <Label htmlFor="moduleCountPerRow">Module Count per Row (optional)</Label>
                        <Input
                ...
                <div className="space-y-2">
                    ...
                    <FileUploader
                        label=""
                        description="Upload ground mount layout or structural details"
