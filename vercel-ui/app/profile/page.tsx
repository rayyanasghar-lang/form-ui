          ...
          <div className="flex items-center gap-2 sm:gap-3">
            <div className="relative hidden md:block">
              ...
              <Input
                ...
                className="w-48 h-8 pl-8 rounded-lg bg-background border-border focus:bg-white text-xs"
              />
            </div>
            ...
            <Button
              ...
              disabled={isSaving}
              size="sm"
              className="h-8 rounded-lg px-3 sm:px-4 bg-primary hover:bg-primary/90 text-primary-foreground font-semibold text-xs shadow-sm"
            >
              {isSaving ? (
                      ...
                      <CardContent>
                        <div className="flex flex-col sm:flex-row items-start gap-6">
                          <div className="shrink-0 relative group">
                            ...
                            <label className="absolute -bottom-1 -right-1 h-8 w-8 bg-white text-muted-foreground rounded-full flex items-center justify-center cursor-pointer shadow-md hover:bg-muted border border-border transition-colors">
                  ...
                  <div className="col-span-12 lg:col-span-4 space-y-6">
                    ...
                    <Card>
                      ...
                      <CardContent className="space-y-4">
                        <div className="flex justify-between items-center text-sm py-2 border-b border-border last:border-0 last:pb-0">
                          <span className="text-muted-foreground">Member Since</span>
                          <span className="font-medium text-foreground">Oct 14, 2024</span>
                        </div>
                         <div className="flex justify-between items-center text-sm py-2 border-b border-border last:border-0 last:pb-0">
                    ...
                    <CardContent>
                      <div className="flex flex-col sm:flex-row items-start gap-8">
                        <div className="shrink-0 space-y-3">
                          <div className="w-32 h-32 bg-background border-2 border-dashed border-border rounded-lg flex flex-col items-center justify-center relative group cursor-pointer hover:bg-muted transition-colors">
                            <Image src="/logo.png" alt="Logo" width={100} height={40} className="h-8 w-auto opacity-50 group-hover:opacity-100 transition-opacity" />
                             <div className="absolute inset-0 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity">
                                <span className="text-xs font-semibold text-foreground bg-card/80 px-2 py-1 rounded shadow-sm">Update</span>
                             </div>
                          </div>
                        </div>
                    ...
                    <Card>
                      ...
                      <CardContent className="space-y-4">
                        {licenses.map((license) => (
                           <div key={license.id} className="p-4 rounded-lg border border-border bg-background hover:bg-muted/50 transition-colors group">
                         ...
                         {licenses.length === 0 && (
                            <div className="p-12 text-center border-2 border-dashed border-zinc-200 rounded-xl bg-zinc-50/50">
                               ...
                               <p className="text-sm font-medium text-foreground">No Credentials Added</p>
                               <p className="text-xs text-muted-foreground mt-1">Add your PE licenses to enable automated signatures.</p>
                            </div>
                         )}
                      </CardContent>
                    </Card>
                ...
                <div className="grid gap-6">
                   <Card>
                      ...
                      <CardContent className="space-y-6">
                         <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between p-4 rounded-lg bg-primary/5 border border-primary/10 gap-4">
                             <div className="flex items-center gap-4">
                                <div className="h-10 w-10 bg-card rounded-full flex items-center justify-center border border-primary/20 shadow-sm">
                                   <Check className="h-5 w-5 text-primary" />
                                </div>
                                <div>
                                   <p className="text-sm font-semibold text-foreground">Multi-Factor Auth Active</p>
                                   <p className="text-xs text-muted-foreground">Primary: SMS Verification</p>
                                </div>
                             </div>
                             <Button size="sm" className="bg-white text-foreground hover:bg-white/90 border border-border shadow-sm">Manage</Button>
                         </div>
                         ...
                         <div className="space-y-1">
                          {[1, 2, 3].map((_, i) => (
                            <div key={i} className="flex items-center justify-between p-3 rounded-lg hover:bg-zinc-50 transition-colors group">
                               <div className="flex items-center gap-4">
                                 <div className={`h-2.5 w-2.5 rounded-full ring-4 ring-card ${i === 0 ? 'bg-primary' : 'bg-muted'}`} />
                                 <div>
                                    <p className="text-sm font-medium text-foreground">Chrome on MacOS</p>
                                    <p className="text-xs text-muted-foreground">Los Angeles, US • {i === 0 ? 'Active Now' : '2 hours ago'}</p>
                                 </div>
                               </div>
                               {i !== 0 && (
